    ...
    def ensure_storage_directory(self):
        ...
        try:
            if not os.path.exists(self.storage_dir):
                ...
                print(f"📁 Using existing storage directory: {self.storage_dir}")
        except Exception as e:
            print(f"❌ Error creating storage directory: {e}")
            # Fallback to current directory
            self.storage_dir = "."
            self.db_path = os.path.join(self.storage_dir, "scan_results.db")
...
<body>
    ...
    def export_scan_to_json(self, scan_id: int, filepath: str):
        ...
        try:
            ...
            print(f"❌ Error exporting scan to JSON: {e}")
